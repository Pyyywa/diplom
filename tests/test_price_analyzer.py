...
class TestEthPriceAnalyzer(unittest.TestCase):
    ...
    def test_analyze_price_influence(self, mock_datetime):
        ...
        correlation = self.eth_price_analyzer.analyze_price_influence(
            eth_symbol="ETHUSDT", btc_symbol="BTCUSDT", lookback_period=60
        )
    ...
    def test_calculate_adjusted_eth_prices(self, mock_datetime):
        ...
        adjusted_prices = self.eth_price_analyzer.calculate_adjusted_eth_prices(
            eth_symbol="ETHUSDT", btc_symbol="BTCUSDT", lookback_period=10
        )
